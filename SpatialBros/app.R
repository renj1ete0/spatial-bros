...
ui <- fluidPage(theme = shinytheme("united"),
      navbarPage(
        ...
        tabPanel("Network Constrained Point Pattern Analysis",
                 titlePanel("Network Kernel Density Estimation"),
                 sidebarLayout(
                   sidebarPanel(
                     "Network Kernel Density Estimation Variable Inputs",
                     selectInput(inputId = "network_type",
                                 label = "Types of Network",
                                 choices = list("Road Network" = "road_network",
                                                "Pedestrian Network" = "pedestrian_network",
                                                "Tram Network" = "tram_network"),
                                 selected = "Childcare Centres"),
                     selectInput(inputId = "location_of_interest",
                                 label = "Location of Interest",
                                 choices = list("Childcare Centres" = "childcare_sp_sf",
                                                "Business Establishments" = "business_est_sp",
                                                "Drinking Fountain" = "drinking_fountain_sp",
                                                "Landmarks" = "landmarks_sp",
                                                "Public Toilets" = "public_toilets_sp_sf"),
                                 selected = "Childcare Centres"),
