...
```{r}
road_lixels <- lixelize_lines(road_network_lines, 800, mindist = 350)
pedestrian_lixels <- lixelize_lines(pedestrian_network, 500, mindist = 350)
tram_lixels <- lixelize_lines(tram_network, 1000, mindist = 350)
```
...
```{r}
road_samples <- lines_center(road_lixels)
pedestrian_samples <- lines_center(pedestrian_lixels)
tram_samples <- lines_center(tram_lixels)
```
